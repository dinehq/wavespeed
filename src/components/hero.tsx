  ...
  return (
    <section className="relative flex flex-col items-center gap-10 overflow-hidden px-6 pt-16 pb-16 md:px-20 md:pt-24">
      ...
      <div className="relative flex w-full flex-col items-stretch gap-2 sm:w-auto sm:flex-row sm:items-start">
        <a
          href="#"
          className="flex items-center justify-center gap-3 rounded-xs bg-foreground px-8 py-4 text-background transition-colors duration-150 hover:bg-foreground/80"
        >
        ...
        <a
          href="#"
          className="bg-surface flex items-center justify-center rounded-xs px-8 py-4 text-foreground transition-colors duration-150 hover:bg-foreground/10"
        >
          <span className="font-mono text-sm leading-4 font-medium tracking-[1.2px] uppercase">
            Documentation
          </span>
