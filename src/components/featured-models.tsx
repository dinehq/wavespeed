  ...
  return (
    <section className="bg-background pt-20 md:pt-30">
      ...
      <div className="mx-auto mt-10 flex max-w-290 justify-center">
        <a
          href="#"
          className="bg-foreground text-background hover:bg-foreground/80 tracking-xl rounded-xs px-4 py-3 font-mono text-sm font-medium transition-colors duration-150"
        >
